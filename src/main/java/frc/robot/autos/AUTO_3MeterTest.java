...
public class AUTO_3MeterTest extends SequentialCommandGroup {
  public AUTO_3MeterTest(RobotContainer robot) {
    try {
      // This line throws the IOException that the compiler is complaining about
      // In your auto setup
      PathPlannerPath path = PathPlannerPath.fromPathFile("3MeterTest");
      ...
      DriverStation.reportError(
          "PathPlanner file '3MeterTest' not found: " + e.getMessage(), e.getStackTrace());
    } catch (Exception e) {
